...
export function group(
  { count, rows }: Awaited<ReturnType<typeof getByRange>>,
  range: DataRange,
) {
...
export function deserializeDataInPlace(
  data: Awaited<ReturnType<typeof getByRange>>,
) {
